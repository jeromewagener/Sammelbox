...
import org.sammelbox.android.model.DatabaseConstants;
...
public final class DatabaseStringUtilities {
	...
	public static String generateTableName(String albumName) {
		return (albumName.toLowerCase(Locale.getDefault())).replace(" ", "_");
	}
	...
	public static String generatePictureTableName(String albumName) {
		return (albumName.toLowerCase(Locale.getDefault())).replace(" ", "_") + DatabaseConstants.PICTURE_TABLE_SUFFIX;
	}
	...
	public static String generateTypeInfoTableName(String albumName) {
		return (albumName.toLowerCase(Locale.getDefault())).replace(" ", "_") + DatabaseConstants.TYPE_INFO_SUFFIX;
	}
	...
	public static String generateIndexTableName(String albumName) {
		return (albumName.toLowerCase(Locale.getDefault())).replace(" ", "_") + DatabaseConstants.INDEX_NAME_SUFFIX;
	}
	...
	public static String generateTempTableName(String albumName) {
		return (albumName.toLowerCase(Locale.getDefault())).replace(" ", "_") + DatabaseConstants.TEMP_TABLE_SUFFIX;
	}
