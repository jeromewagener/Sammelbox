...
public class BrowserFacade {
	...
	public static void rerunLastQuery() { Utilities.performLastQuery(ApplicationUI.getAlbumItemSWTBrowser()); }
	...
	public static void performBrowserQueryAndShow(String sqlQuery) { Utilities.performBrowserQueryAndShow(ApplicationUI.getAlbumItemSWTBrowser(), sqlQuery); }
	...
	public static void showResultSet(AlbumItemResultSet resultSet) { Utilities.showResultSet(ApplicationUI.getAlbumItemSWTBrowser(), resultSet); }
	public static void loadHtmlFromInputStream(InputStream fileInputStream) { Utilities.loadHtmlPage(ApplicationUI.getAlbumItemSWTBrowser(), fileInputStream); }
	public static void showCreateNewAlbumPage(AlbumItem albumItem) { FeedbackCreator.showCreateNewAlbumPage(ApplicationUI.getAlbumItemSWTBrowser(), albumItem); }
	public static void showCreateAlterAlbumPage(AlbumItem albumItem) { FeedbackCreator.showCreateAlterAlbumPage(ApplicationUI.getAlbumItemSWTBrowser(), albumItem); }
