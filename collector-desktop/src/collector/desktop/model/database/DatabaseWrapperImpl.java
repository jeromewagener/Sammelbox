...
public class DatabaseWrapperImpl  {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(DatabaseWrapperImpl.class);
	...
	static boolean albumHasPictureField(String albumName) throws DatabaseWrapperOperationException {		
	...
	static long addNewAlbumItem(AlbumItem item, boolean updateContentVersion) throws DatabaseWrapperOperationException {
	...
	static AlbumItemResultSet executeSQLQuery(String sqlStatement, String albumName) throws DatabaseWrapperOperationException {
		...
		Map<Integer, MetaItemField> metaInfoMap = DatabaseWrapperImpl.getAlbumItemMetaMap(albumName);
	...
	static List<String> listAllAlbums() throws DatabaseWrapperOperationException {
	...
	static boolean albumNameIsAvailable(String requestedAlbumName) throws DatabaseWrapperOperationException {
		for (String albumName : DatabaseWrapperImpl.listAllAlbums()) {
	...
	static boolean itemFieldNameIsAvailable(String albumName, String requestedFieldName) throws DatabaseWrapperOperationException {
		for (MetaItemField metaItemField : DatabaseWrapperImpl.getAlbumItemFieldNamesAndTypes(albumName)) {
	...
	static AlbumItem fetchAlbumItem(String albumName, long albumItemId) throws DatabaseWrapperOperationException {
	...
	static List<AlbumItem> fetchAlbumItemsFromDatabase(String queryString) throws DatabaseWrapperOperationException {
	...
	private static void createTableWithIdAsPrimaryKey(String tableName, List<MetaItemField> columns, boolean temporaryTable, boolean ifNotExistsClause) throws DatabaseWrapperOperationException {
		...
		sb.append(" ( ");
		sb.append(DatabaseFacade.ID_COLUMN_NAME);
